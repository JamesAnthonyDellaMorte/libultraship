...
set(STB_VENDORED_HEADER_PATH "${CMAKE_CURRENT_SOURCE_DIR}/cmake/dependencies/vendor/stb/stb_image.h")
...
if(STB_NEEDS_DOWNLOAD AND EXISTS "${STB_VENDORED_HEADER_PATH}")
    file(SIZE "${STB_VENDORED_HEADER_PATH}" STB_VENDORED_HEADER_SIZE)
    if(STB_VENDORED_HEADER_SIZE GREATER 0)
        file(MAKE_DIRECTORY "${STB_DIR}")
        file(COPY "${STB_VENDORED_HEADER_PATH}" DESTINATION "${STB_DIR}")
        set(STB_NEEDS_DOWNLOAD OFF)
    endif()
endif()
